...
assert.ok(result.waveSamples[2].hp>1);
assert.ok(result.waveSamples[3].hp>1.5);
assert.ok(result.waveSamples[3].damage>1.25);
assert.ok(result.waveSamples[4].count>1.6);
assert.ok(result.waveSamples.at(-1).hp>3.9);
assert.ok(result.waveSamples.at(-1).damage>2.7);
assert.ok(result.waveSamples.at(-1).speed>1.2);
assert.ok(result.waveSamples.at(-1).count>=1.89);
assert.ok(result.earlyEnemy.maxHp<100);
assert.ok(result.earlyEnemy.damage<10);
assert.ok(result.lateEnemy.maxHp>220);
assert.ok(result.lateEnemy.damage>16);
